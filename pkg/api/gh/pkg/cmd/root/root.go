...
import (
	...
	authCmd "github.com/scmn-dev/secman-v1/pkg/api/gh/pkg/cmd/auth"
	"github.com/scmn-dev/secman-v1/pkg/api/gh/pkg/cmd/factory"
	repoCmd "github.com/scmn-dev/secman-v1/pkg/api/gh/pkg/cmd/repo"
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{
			"help:feedback": heredoc.Doc(`
				Open an issue using at https://github.com/scmn-dev/secman-v1/pkg/api/gh/issues
			`),
		},
	}
